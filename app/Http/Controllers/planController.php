...
過度の負担をかけますので減量をする体重を減らして下さい';
	...
	public function plandell(Request $request)
	{

		$stop = $request->input('stop');

		if($stop==1){
			return redirect('plandell');
		}

	}

	public function plandelldecide(Request $request)
	{
		return view('plan.plandell');
	}

	public function plandelldecidepost(Request $request)
	{
