...
<h1 class="dai3">あなたにピッタリなダイエットプランを提案します</h1>
<p class="text2">ダイエットを実行する期間やどのようなダイエットが<br>理想的なダイエットプランなのかをプラン診断を通して<br>あなたにピッタリなダイエットプランを提案します。</p>
<p class="text2m">ダイエットの実行期間やどのようなダイエットが理想的なダイエットプランなのかをプラン診断を通してあなたにピッタリなダイエットプランを提案します</p>
<h1 class="dai4">体重の推移とダイエット実行率がひとめでわかるグラフ機能</h1>
<p class="text3">毎日の体重の推移とどれくらいダイエットを<br>実行できているかをわかりやすい線グラフ<br>円グラフで表示します</p>
@endsection
